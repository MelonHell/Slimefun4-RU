...
public class ElevatorPlate extends SimpleSlimefunItem<BlockUseHandler> {
    ...
    private BlockPlaceHandler onPlace() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                Block b = e.getBlock();
                BlockStorage.addBlockInfo(b, DATA_KEY, ChatColor.WHITE + "Этаж #0");
    ...
    public void openEditor(Player p, Block b) {
        ...
        menu.addItem(4, new CustomItemStack(Material.NAME_TAG, "&7Название этажа &e(Нажми, чтобы изменить)", "", ChatColor.WHITE + ChatColors.color(BlockStorage.getLocationInfo(b.getLocation(), DATA_KEY))));
