...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private BlockPlaceHandler onPlace() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                ...
                BlockStorage.addBlockInfo(b, "text", "§bПривет, я голограмма, §3настрой меня при помощи проектора");
    ...
    private static void openEditor(@Nonnull Player p, @Nonnull Block projector) {
        ...
        menu.addItem(0, new CustomItem(Material.NAME_TAG, "&7Текст &e(Нажми, чтобы изменить)", "", "&r" + ChatColors.color(BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
        ...
        menu.addItem(1, new CustomItem(Material.CLOCK, "&7Смещение: &e" + NumberUtils.roundDecimalNumber(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&rLeft Click: &7+0.1", "&rRight Click: &7-0.1"));
