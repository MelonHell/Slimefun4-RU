...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack INFUSED_MAGNET = new SlimefunItemStack("INFUSED_MAGNET", HeadTexture.MAGNET, "&aУсиленный магнит", MelonUtils.splitLore("", "&fМагически усиленный магнит притягивает все предметы поблизости в достаточно большом радиусе и помещает их в твой инвентарь", "", LoreBuilder.CROUCH_TO_USE));
    ...
    public static final SlimefunItemStack FLASK_OF_KNOWLEDGE = new SlimefunItemStack("FLASK_OF_KNOWLEDGE", Material.GLASS_BOTTLE, "&cПустой пузырёк опыта", MelonUtils.splitLore("", "&fПозволяет сохранить часть часть твоего опыта в пузырьке", "&7Стоимость: &a1 Уровень"));
    ...
    public static final SlimefunItemStack COOLER = new SlimefunItemStack("COOLER", HeadTexture.COOLER, "&bХолодильник", MelonUtils.splitLore("&fПозволяет хранить соки/смузи и автоматически выпивать их при голоде, когда он у тебя в инвентаре", "", "&7Размер: &e27", BACKPACK_ID, "", LoreBuilder.RIGHT_CLICK_TO_OPEN));
    ...
    public static final SlimefunItemStack PICKAXE_OF_THE_SEEKER = new SlimefunItemStack("PICKAXE_OF_THE_SEEKER", Material.DIAMOND_PICKAXE, "&aКирка искателя", MelonUtils.splitLore("&fНаправит тебя к ближайшей руде, но при этом получит урон", "", "&7&eПКМ&7: Узнать направление к руде"));
    ...
    public static final SlimefunItemStack BOOTS_OF_THE_STOMPER = new SlimefunItemStack("BOOTS_OF_THE_STOMPER", Material.LEATHER_BOOTS, Color.AQUA, "&bСапоги стражника", MelonUtils.splitLore("", "&9Весь урон от падения будет нанесён всем врагам поблизости", "", "&9+ Защита от падения"));
    ...
    public static final SlimefunItemStack STRANGE_NETHER_GOO = new SlimefunItemStack("STRANGE_NETHER_GOO", Material.PURPLE_DYE, "&5Странная адская слизь", MelonUtils.splitLore("", "&fСтранная биологическая материя, которую можно выторговать у пиглинов"));
    ...
    public static final SlimefunItemStack OUTPUT_CHEST = new SlimefunItemStack("OUTPUT_CHEST", Material.CHEST, "&4Сундук вывода", MelonUtils.splitLore("", "&c&oОбычная машина попытается положить предметы в этот сундук, если он находится рядом с Раздатчиком."));
    public static final SlimefunItemStack IGNITION_CHAMBER = new SlimefunItemStack("IGNITION_CHAMBER", Material.DROPPER, "&4Устройство поддержания огня", MelonUtils.splitLore("", "&fПосле потухания огня в Плавильни зажигает его заново, если наполнить его Огнивом и поместить рядом с Раздатчиком."));
    ...
    public static final SlimefunItemStack SOULBOUND_RUNE = new SlimefunItemStack("ANCIENT_RUNE_SOULBOUND", new ColoredFireworkStar(Color.fromRGB(47, 0, 117), "&7Древняя руна &8&l[&5&lБезутратность&8&l]", MelonUtils.splitLore("&eБросьте эту руну на выпавший предмет, чтобы &5привязать &eэтот предмет к вашей душе.", " ", "&eРекомендуется использовать эту руну только на &6важных &eпредметах.", " ", "&eПредметы, привязанные к вашей душе, не упадут после смерти.")));
    public static final SlimefunItemStack ENCHANTMENT_RUNE = new SlimefunItemStack("ANCIENT_RUNE_ENCHANTMENT", new ColoredFireworkStar(Color.fromRGB(255, 217, 25), "&7Древняя руна &8&l[&6&lЗачарование&8&l]", MelonUtils.splitLore("&eБросьте эту руну на выпавший предмет, чтобы наложить на него случайные чары.")));
    public static final SlimefunItemStack VILLAGER_RUNE = new SlimefunItemStack("ANCIENT_RUNE_VILLAGERS", new ColoredFireworkStar(Color.fromRGB(160, 20, 5), "&7Древняя руна &8&l[&4&lКрестьяне&8&l]", MelonUtils.splitLore("&eЩелкните правой кнопкой мыши деревенского жителя, чтобы очистить его текущую работу и торги.", "&eПо прошествии некоторого времени сельчанин снова начнет искать работу.")));
    ...
    public static final SlimefunItemStack GPS_MARKER_TOOL = new SlimefunItemStack("GPS_MARKER_TOOL", Material.REDSTONE_TORCH, "&bGPS инструмент отметок", MelonUtils.splitLore("", "&fПозволяет установить маршрутную точку в том месте, в котором вы ее разместите."));
    public static final SlimefunItemStack GPS_CONTROL_PANEL = new SlimefunItemStack("GPS_CONTROL_PANEL", HeadTexture.GPS_CONTROL_PANEL, "&bGPS панель управления", MelonUtils.splitLore("", "&fПозволяет отслеживать ваши спутники и управлять вашими путевыми точками"));
    public static final SlimefunItemStack GPS_EMERGENCY_TRANSMITTER = new SlimefunItemStack("GPS_EMERGENCY_TRANSMITTER", HeadTexture.GPS_TRANSMITTER, "&cЭкстренный GPS передатчик", MelonUtils.splitLore("", "&fНошение этого в инвентаре автоматически устанавливает путевую точку в вашем местоположении, когда вы умираете."));

    public static final SlimefunItemStack ANDROID_INTERFACE_FUEL = new SlimefunItemStack("ANDROID_INTERFACE_FUEL", Material.DISPENSER, "&7Интерфейс робота &c(Топливо)", MelonUtils.splitLore("", "&fЭлементы, хранящиеся в этом интерфейсе, будут вставлены в слот для топлива Android, когда его сценарий говорит им об этом."));
    public static final SlimefunItemStack ANDROID_INTERFACE_ITEMS = new SlimefunItemStack("ANDROID_INTERFACE_ITEMS", Material.DISPENSER, "&7Интерфейс робота &9(Предметы)", MelonUtils.splitLore("", "&fПредметы, хранящиеся в инвентаре Android, будут вставлены в этот интерфейс, когда его сценарий говорит им об этом."));

    public static final SlimefunItemStack GPS_GEO_SCANNER = new SlimefunItemStack("GPS_GEO_SCANNER", HeadTexture.GEO_SCANNER, "&bGPS гео-сканнер", MelonUtils.splitLore("", "&fСканирует чанк на наличие природных ресурсов, таких как &8нефть"));
    public static final SlimefunItemStack PORTABLE_GEO_SCANNER = new SlimefunItemStack("PORTABLE_GEO_SCANNER", Material.CLOCK, "&bПортативный гео-сканнер", MelonUtils.splitLore("", "&fСканирует кусок на предмет природных ресурсов", "", "&eПКМ&7: Сканировать"));
    public static final SlimefunItemStack GEO_MINER = new SlimefunItemStack("GEO_MINER", HeadTexture.GEO_MINER, "&6Гео-шахтёр", MelonUtils.splitLore("", "&eДобывает ресурсы из чанка", "&eЭти ресурсы нельзя добыть киркой.", "", LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), LoreBuilder.speed(1), LoreBuilder.powerPerSecond(48), "", "&c&l! &cОбязательно сначала выполните гео-сканирование чанка"));
    public static final SlimefunItemStack OIL_PUMP = new SlimefunItemStack("OIL_PUMP", HeadTexture.OIL_PUMP, "&4Нефтяной насос", MelonUtils.splitLore("", "&7Накачивает нефть и заливает её в ведра", "", "&c&l! &cОбязательно сначала выполните гео-сканирование чанка"));
    ...
    public static final SlimefunItemStack REFINERY = new SlimefunItemStack("REFINERY", Material.PISTON, "&cТопливный завод", "", "&fПерерабатывает нефть для создания бензина");
    ...
    public static final SlimefunItemStack GPS_TELEPORTATION_MATRIX = new SlimefunItemStack("GPS_TELEPORTATION_MATRIX", Material.IRON_BLOCK, "&bGPS матрица телепорта", MelonUtils.splitLore("", "&fЭто главный компонент вашего телепорта.", "&fЭта матрица позволяет игрокам выбирать из всех путевых точек, созданных игроком, разместившим это устройство."));
    public static final SlimefunItemStack GPS_ACTIVATION_DEVICE_SHARED = new SlimefunItemStack("GPS_ACTIVATION_DEVICE_SHARED", Material.STONE_PRESSURE_PLATE, "&fGPS устройство активации &3(Публичное)", MelonUtils.splitLore("", "&fПоместите это на матрицу телепортации и встаньте на эту пластину, чтобы активировать процесс телепортации."));
    public static final SlimefunItemStack GPS_ACTIVATION_DEVICE_PERSONAL = new SlimefunItemStack("GPS_ACTIVATION_DEVICE_PERSONAL", Material.STONE_PRESSURE_PLATE, "&fGPS устройство активации &a(Личное)", MelonUtils.splitLore("", "&fПоместите это на матрицу телепортации и встаньте на эту пластину, чтобы активировать процесс телепортации.", "", "&fЭта версия позволяет использовать его только лицу, разместившему это устройство."));
    public static final SlimefunItemStack PORTABLE_TELEPORTER = new SlimefunItemStack("PORTABLE_TELEPORTER", Material.COMPASS, "&bПортативный телепорт", MelonUtils.splitLore("", "&fЭто устройство позволяет телепортироваться к вашим путевым точкам из любого места", "", LoreBuilder.powerCharged(0, 50), "", LoreBuilder.RIGHT_CLICK_TO_USE));

    public static final SlimefunItemStack ELEVATOR_PLATE = new SlimefunItemStack("ELEVATOR_PLATE", Material.STONE_PRESSURE_PLATE, "&bЛифтовая плита", MelonUtils.splitLore("", "&fПоместите пластину лифта на каждый этаж, и вы сможете телепортироваться между ними.", "", "&eЩелкните правой кнопкой мыши этот блок&7, чтобы назвать его"));
    public static final SlimefunItemStack INFUSED_HOPPER = new SlimefunItemStack("INFUSED_HOPPER", Material.HOPPER, "&5Усиленная воронка", MelonUtils.splitLore("", "&fПри размещении автоматически подбирает ближайшие предметы в радиусе 7x7x7."));
    ...
    public static final SlimefunItemStack ELECTRIC_SMELTERY = new SlimefunItemStack("ELECTRIC_SMELTERY", Material.FURNACE, "&cЭлектрическая плавильня", "", "&4Только сплавы, пыль не превращается в слитки", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.speed(1), LoreBuilder.powerPerSecond(20));
    public static final SlimefunItemStack ELECTRIC_SMELTERY_2 = new SlimefunItemStack("ELECTRIC_SMELTERY_2", Material.FURNACE, "&cЭлектрическая плавильня &7- &eII", "", "&4Только сплавы, пыль не превращается в слитки", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.speed(3), LoreBuilder.powerPerSecond(40));
    ...
    // Cargo
    public static final SlimefunItemStack CARGO_MANAGER = new SlimefunItemStack("CARGO_MANAGER", HeadTexture.CARGO_MANAGER, "&6Грузовой контроллер", "", "&fОсновной компонент транспортной сети предметов");
    public static final SlimefunItemStack CARGO_CONNECTOR_NODE = new SlimefunItemStack("CARGO_NODE", HeadTexture.CARGO_CONNECTOR_NODE, "&7Грузовой модуль &c(Коннектор)", "", "&fГрузовая соединительная труба");
    public static final SlimefunItemStack CARGO_INPUT_NODE = new SlimefunItemStack("CARGO_NODE_INPUT", HeadTexture.CARGO_INPUT_NODE, "&7Грузовой модуль &c(Ввод)", "", "&fВходная труба для груза");
    public static final SlimefunItemStack CARGO_OUTPUT_NODE = new SlimefunItemStack("CARGO_NODE_OUTPUT", HeadTexture.CARGO_OUTPUT_NODE, "&7Грузовой модуль &c(Вывод)", "", "&fТруба вывода груза");
    public static final SlimefunItemStack CARGO_OUTPUT_NODE_2 = new SlimefunItemStack("CARGO_NODE_OUTPUT_ADVANCED", HeadTexture.CARGO_OUTPUT_NODE, "&6Улучшенный грузовой модуль &c(Вывод)", "", "&fТруба вывода груза");
    ...
    public static final SlimefunItemStack NUCLEAR_REACTOR = new SlimefunItemStack("NUCLEAR_REACTOR", HeadTexture.NUCLEAR_REACTOR, "&2Ядерный реактор", MelonUtils.splitLore("", "&fТребуется охлаждение!", "&8\u21E8 &bДолжен быть окружен водой", "&8\u21E8 &bДолжен поставляться с ячейками для охлаждающей жидкости реактора.", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(16384), LoreBuilder.powerPerSecond(500)));
    public static final SlimefunItemStack NETHER_STAR_REACTOR = new SlimefunItemStack("NETHERSTAR_REACTOR", HeadTexture.NETHER_STAR_REACTOR, "&fРектор адской звезды", MelonUtils.splitLore("", "&fРаботает на Звёздах ада", "&8\u21E8 &bДолжен быть окружен водой", "&8\u21E8 &bДолжен поставляться с ячейками для охлаждающей жидкости из Адского льда.", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.GENERATOR), LoreBuilder.powerBuffer(32768), LoreBuilder.powerPerSecond(1024), "&8\u21E8 &4Заставляет окружающих существ иссыхать"));
    public static final SlimefunItemStack REACTOR_ACCESS_PORT = new SlimefunItemStack("REACTOR_ACCESS_PORT", Material.CYAN_TERRACOTTA, "&2Реакторный порт доступа", MelonUtils.splitLore("", "&fПозволяет взаимодействовать с реактором через грузовые узлы, также может использоваться в качестве буфера.", "", "&8\u21E8 &eДолжен быть размещен на &a3 блока &eнад реактором."));
    ...
    public static final SlimefunItemStack MAGNESIUM_SALT = new SlimefunItemStack("MAGNESIUM_SALT", Material.SUGAR, "&cМагниевая соль", MelonUtils.splitLore("", "&7Особый вид топлива, которое можно использовать в генераторе, работающем на магнии."));
