...
public class ArmorForge extends AbstractCraftingTable {
    ...
    public ArmorForge(ItemGroup itemGroup, SlimefunItemStack item) {
        super(itemGroup, item, new ItemStack[] { null, null, null, null, new ItemStack(Material.ANVIL), null, null, new CustomItemStack(Material.DISPENSER, "Раздатчик (Направлен вверх)"), null }, BlockFace.SELF);
    }
